...
img_norm_cfg = dict(mean=[0.25081184*256, 0.57518236*256, 0.33086171*256], std=[0.09779429*256, 0.15974009*256, 0.14491257*256], to_rgb=True)
train_pipeline = [
...
log_level = 'INFO'
work_dir = './work_dirs/cas_x101_64x4d_fpn_htc_1x_1gpu_lr_no_change_own_mean_std'
# load_from = 'data/pretrained/htc_dconv_c3-c5_mstrain_400_1400_x101_64x4d_fpn_20e_20190408-0e50669c.pth'
load_from = "/home/reid/ChronousZ/UODAC/underwater-objection-detection/data/pretrained/htc_dconv_c3-c5_mstrain_400_1400_x101_64x4d_fpn_20e_20190408-0e50669c.pth"
resume_from = None
workflow = [('train', 1)]
