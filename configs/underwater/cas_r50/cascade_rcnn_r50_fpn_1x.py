...
log_level = 'INFO'
work_dir = './work_dirs/cascade_rcnn_r50_fpn_1x_for_gpu'
# load_from = './data/pretrained/cascade_rcnn_r50_fpn_20e_20181123-db483a09.pth'
load_from = "/home/reid/ChronousZ/UODAC/underwater-objection-detection/data/pretrained/cascade_rcnn_r50_fpn_1x_20190501-3b6211ab.pth"
resume_from = None
workflow = [('train', 1)]
